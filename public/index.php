...
<body>
    ...
    ?>
    <main id="maincontent">
        <form name="urlform" id="content" action="<?php echo ROOT ?>/set" method="POST">
            <h2>Paste your link here!</h2>
            <input type="hidden" name="token" value="<?= htmlspecialchars(store(), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?>" />
            <span class="input-wrapper">
                <input type="text" name="input" class="input square" placeholder="https://youtu.be/dQw4w9WgXcQ" id="search-input" maxlength="2048" required autofocus />
